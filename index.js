...
// When nestedFunction was created a sort of pipeline between it and it's parent function myFunction called closure was created allowing nestedFunction to access it's parents state.  Similar to prototype, but for functions
...
const zooAnimals = [
  ...
  */
  ...
  function lowPopulationAnimals(){
    const endangered = zooAnimals.filter(item => item.population < 5);
